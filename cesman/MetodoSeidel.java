        ...
        if (tamanio == 3) {//se puede cambiar
            ...
            if (determinanteTotal != 0){
                ...
                for (int i = 0; i < 500; i++) {
                    ...
                    y = (((ecuacion3x3[1][3]) - ((ecuacion3x3[1][0]) * x) - ((ecuacion3x3[1][2]) * zi)) / ecuacion3x3[1][1]);
                    z = (((ecuacion3x3[2][3]) - ((ecuacion3x3[2][0]) * x) - ((ecuacion3x3[2][1]) * y)) / ecuacion3x3[2][2]);
        ...
        if (tamanio == 4){
            ...
            if (determinanteTotal != 0){
                ...
                for (int i = 0; i < 500; i++) {
                    ...
                    y = (((ecuacion4X4[1][4]) - ((ecuacion4X4[1][0]) * x) - ((ecuacion4X4[1][2]) * zi) - (ecuacion4X4[1][3] * wi)) / ecuacion4X4[1][1]);
                    z = (((ecuacion4X4[2][4]) - ((ecuacion4X4[2][0]) * x) - ((ecuacion4X4[2][1]) * y) - (ecuacion4X4[2][3] * wi)) / ecuacion4X4[2][2]);
                    w = (((ecuacion4X4[3][4]) - ((ecuacion4X4[3][0]) * x) - ((ecuacion4X4[3][1]) * y) - (ecuacion4X4[3][2] * z)) / ecuacion4X4[3][3]);
                    System.out.println("x" + (++a) + " = " + x);
                    System.out.println("y" + (++b) + " = " + y);
                    System.out.println("z" + (++c) + " = " + z);
                    ...
                    if (((Math.sqrt(Math.pow(restax, 2) + Math.pow(restay, 2) + Math.pow(restaz, 2) + Math.pow(restaw, 2))) <= error)
                            ||( (Math.abs(1 - (xi / x)) < error) && (Math.abs(1 - (yi / y)) < error) && (Math.abs(1 - (zi / z)) < error)
                            && (Math.abs(1 - (wi / w)) < error))) {
                        System.out.println("Solucion: ");
                        System.out.println("x = " + x);
                        System.out.println("y = " + y);
                        System.out.println("z = " + z);
        ...
        if (tamanio == 5){
            ...
            if (determinanteTotal != 0){
                ...
                for (int i = 0; i < 500; i++) {
                    ...
                    y = (((ecuacion5x5[1][5]) - ((ecuacion5x5[1][0]) * x) - ((ecuacion5x5[1][2]) * zi) - (ecuacion5x5[1][3] * wi) - (ecuacion5x5[1][4] * ti)) / ecuacion5x5[1][1]);
                    z = (((ecuacion5x5[2][5]) - ((ecuacion5x5[2][0]) * x) - ((ecuacion5x5[2][1]) * y) - (ecuacion5x5[2][3] * wi) - (ecuacion5x5[2][4] * ti)) / ecuacion5x5[2][2]);
                    w = (((ecuacion5x5[3][5]) - ((ecuacion5x5[3][0]) * x) - ((ecuacion5x5[3][1]) * y) - (ecuacion5x5[3][2] * z) - (ecuacion5x5[3][4] * ti)) / ecuacion5x5[3][3]);
                    t = (((ecuacion5x5[4][5]) - ((ecuacion5x5[4][0]) * x) - ((ecuacion5x5[4][1]) * y) - (ecuacion5x5[4][2] * z) - (ecuacion5x5[4][3] * w)) / ecuacion5x5[4][4]);
                    System.out.println("x" + (++a) + " = " + x);
                    System.out.println("y" + (++b) + " = " + y);
                    System.out.println("z" + (++c) + " = " + z);
                    System.out.println("w" + (++d) + " = " + w);
        ...
        if (tamanio == 6){
            ...
            if (determinanteTotal != 0){
                ...
                for (int i = 0; i < 500; i++) {
                    ...
                    y = (((ecuacion6x6[1][6]) - ((ecuacion6x6[1][0]) * x) - ((ecuacion6x6[1][2]) * zi) - (ecuacion6x6[1][3] * wi) - (ecuacion6x6[1][4] * ti) - (ecuacion6x6[1][5] * ui)) / ecuacion6x6[1][1]);
                    z = (((ecuacion6x6[2][6]) - ((ecuacion6x6[2][0]) * x) - ((ecuacion6x6[2][1]) * y) - (ecuacion6x6[2][3] * wi) - (ecuacion6x6[2][4] * ti) - (ecuacion6x6[2][5] * ui)) / ecuacion6x6[2][2]);
                    w = (((ecuacion6x6[3][6]) - ((ecuacion6x6[3][0]) * x) - ((ecuacion6x6[3][1]) * y) - (ecuacion6x6[3][2] * z) - (ecuacion6x6[3][4] * ti) - (ecuacion6x6[3][5] * ui)) / ecuacion6x6[3][3]);
                    t = (((ecuacion6x6[4][6]) - ((ecuacion6x6[4][0]) * x) - ((ecuacion6x6[4][1]) * y) - (ecuacion6x6[4][2] * z) - (ecuacion6x6[4][3] * w) - (ecuacion6x6[4][5] * ui)) / ecuacion6x6[4][4]);
                    u = (((ecuacion6x6[5][6]) - ((ecuacion6x6[5][0]) * x) - ((ecuacion6x6[5][1]) * y) - (ecuacion6x6[5][2] * z) - (ecuacion6x6[5][3] * w) - (ecuacion6x6[5][4] * t)) / ecuacion6x6[5][5]);
                    System.out.println("x" + (++a) + " = " + x);
                    System.out.println("y" + (++b) + " = " + y);
                    System.out.println("z" + (++c) + " = " + z);
                    System.out.println("w" + (++d) + " = " + w);
...
/*
for (int i = 0; i < listax.toArray().length; i++) {
                int q = i;
                for (int j = 0; j < listax.toArray().length + 1; j++){
                    k = j;
                    if (j == listax.toArray().length || (i == 0 && j == 0)){
                        continue;
                    }
                    if (i != 0){
                        k--;
                    }
                    ecuacion3x3[i][j] = (Math.pow(count, k));
                }
            }
 */